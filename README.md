...
1. **Sequential Monte Carlo samplers** 
...
2. **Sequential Monte Carlo for Bayesian Computation**  
...
4. **MCMC Methods for Functions: Modifying Old Algorithms to Make Them Faster**  
   Cotter, S. L., Roberts, G. O., Stuart, A. M., White, D. (2013).  
   Link: https://eprints.maths.manchester.ac.uk/2215/1/1202.0709v3.pdf

5. **Accelerating astronomical and cosmological inference with Preconditioned Monte Carlo**  
...
9. **Validating Sequential Monte Carlo for Gravitational-Wave Inference**  
